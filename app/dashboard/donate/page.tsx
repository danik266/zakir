...
const DonatePage = () => {
  ...
  return (
    <>
    <div className="flex flex-col items-center justify-center px-5 pt-20 dark:bg-gray-900">
      ...
      <div className="bg-white p-6  shadow-md flex flex-col items-center gap-4 rounded-2xl dark:bg-gray-800">
